...
with open('../医疗/39jbk(5).json', 'r',encoding='utf-8') as f:
    contents = f.read()
...
with open('json39_tq2.json', 'wb') as ff:
    ff.write(js39.encode('utf-8'))


with open('json39_tq2.json', 'r',encoding='utf-8') as f:
    content = f.read()
